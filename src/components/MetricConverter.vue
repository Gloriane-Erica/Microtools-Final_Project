<template>
    <div class="col-md-12 p-5" v-if="showMetricConverterComponent">
          ...
          <div class="row">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <select class="form-select mt-2" id="fromUnit" v-model="fromUnit" :disabled="result">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <select class="form-select mt-2" id="toUnit" v-model="toUnit" :disabled="result">
                        <option v-for="unit in metricUnits" :key="unit">{{ unit }}</option>
                    </select>
                </div>
            </div>
