<template>
    <div class="col-md-12 p-5" v-if="showCountdownTimerComponent">
        ...
        <div v-if="isRunning" class="mt-3">
            ...
            <H1 style="font-weight: bold; font-size: 80px" class="form-control text-primary text-center p-5" rows="1" readonly>
